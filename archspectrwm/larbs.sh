...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/bazeeel/baz-voidrice.git" && repobranch="master"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/bazeeel/baz-spectrwm/master/archspectrwm/progs.csv"
